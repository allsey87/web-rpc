...
const SCHEMAS = {
  Stats: { kind: "struct", fields: [["label", "string"], ["count", "u32"]] },
  Fault: { kind: "enum", variants: [["NotFound", "unit"], ["Bad", { kind: "newtype", inner: "string" }]] },
};

const METHODS = [
  { name: "add", kind: "value", args: [{ kind: "postcard", schema: "u32" }, { kind: "postcard", schema: "u32" }], returns: { kind: "postcard", schema: "u32" } },
  { name: "wide", kind: "value", args: [{ kind: "postcard", schema: "u64" }], returns: { kind: "postcard", schema: "u64" } },
  { name: "blob", kind: "value", args: [{ kind: "postcard", schema: { kind: "seq", inner: "u8" } }], returns: { kind: "postcard", schema: "u32" } },
  { name: "stats", kind: "value", args: [{ kind: "postcard", schema: "string" }, { kind: "postcard", schema: "u32" }], returns: { kind: "postcard", schema: { kind: "ref", name: "Stats" } } },
  { name: "echo", kind: "value", args: [{ kind: "js", transfer: false }], returns: { kind: "js", transfer: false } },
  { name: "take", kind: "value", args: [{ kind: "js", transfer: true }], returns: { kind: "postcard", schema: "u32" } },
  { name: "give", kind: "value", args: [{ kind: "postcard", schema: "u32" }], returns: { kind: "js", transfer: true } },
  { name: "maybe", kind: "value", args: [{ kind: "postcard", schema: "bool" }], returns: { kind: "option", inner: { kind: "js", transfer: false } } },
  { name: "fallible", kind: "value", args: [{ kind: "postcard", schema: "bool" }], returns: { kind: "result", ok: { kind: "postcard", schema: "u32" }, err: { kind: "postcard", schema: { kind: "ref", name: "Fault" } } } },
  { name: "fallibleText", kind: "value", args: [{ kind: "postcard", schema: "bool" }], returns: { kind: "result", ok: { kind: "postcard", schema: "u32" }, err: { kind: "postcard", schema: "string" } } },
  { name: "note", kind: "notify", args: [{ kind: "postcard", schema: "string" }], returns: null },
  { name: "notes", kind: "value", args: [], returns: { kind: "postcard", schema: "u32" } },
  { name: "counters", kind: "stream", args: [{ kind: "postcard", schema: "u32" }], returns: { kind: "postcard", schema: "u32" } },
  { name: "slow", kind: "value", args: [{ kind: "postcard", schema: "u32" }], returns: { kind: "postcard", schema: "u32" } },
  { name: "borrowed", kind: "value", args: [{ kind: "inline", schema: "string" }, { kind: "inline", schema: { kind: "seq", inner: "u8" } }], returns: { kind: "postcard", schema: "string" } },
];

const HANDLERS = [
];

export class SampleClient extends Endpoint {
  constructor(options) {
    super(options, "SampleClient", new Codec(SCHEMAS), METHODS, HANDLERS);
  }
  add(left, right) {
    return this._request(0, [left, right]);
  }
  wide(value) {
    return this._request(1, [value]);
  }
  blob(data) {
    return this._request(2, [data]);
  }
  stats(label, count) {
    return this._request(3, [label, count]);
  }
  echo(value) {
    return this._request(4, [value]);
  }
  take(buffer) {
    return this._request(5, [buffer]);
  }
  give(size) {
    return this._request(6, [size]);
  }
  maybe(present) {
    return this._request(7, [present]);
  }
  fallible(succeed) {
    return this._request(8, [succeed]);
  }
  fallibleText(succeed) {
    return this._request(9, [succeed]);
  }
  note(message) {
    this._notify(10, [message]);
  }
  notes() {
    return this._request(11, []);
  }
  counters(count, callback) {
    return this._stream(12, [count], callback);
  }
  slow(millis) {
    return this._request(13, [millis]);
  }
  borrowed(text, data) {
    return this._request(14, [text, data]);
  }
}
