...
const METHODS = [
  { name: "now", kind: "value", args: [], returns: { kind: "postcard", schema: "u64" } },
];

const HANDLERS = [
];

export class ClockClient extends Endpoint {
  constructor(options) {
    super(options, "ClockClient", new Codec(SCHEMAS), METHODS, HANDLERS);
  }
  now() {
