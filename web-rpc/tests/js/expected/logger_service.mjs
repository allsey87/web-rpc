...
const HANDLERS = [
  { name: "log", kind: "notify", args: [{ kind: "postcard", schema: "string" }], returns: null },
];

export class LoggerService extends Endpoint {
  constructor(options) {
    super(options, "LoggerService", new Codec(SCHEMAS), METHODS, HANDLERS);
  }
}
